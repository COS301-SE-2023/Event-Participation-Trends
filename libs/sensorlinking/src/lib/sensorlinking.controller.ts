import { Controller, UseGuards, SetMetadata, Get, Param, Post, Body } from '@nestjs/common';
import { RbacGuard, CsrfGuard, JwtGuard } from '@event-participation-trends/api/guards';
