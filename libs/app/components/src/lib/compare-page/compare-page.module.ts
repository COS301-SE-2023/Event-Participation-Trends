...
import { matRadioButtonUnchecked, matSearch } from "@ng-icons/material-icons/baseline";
...
@NgModule({
    ...
    imports: [
        CommonModule, 
        FormsModule,
        NgIconsModule.withIcons({matCheckCircleOutline, matRadioButtonUnchecked, heroAdjustmentsHorizontal, matSearch})
    ],
